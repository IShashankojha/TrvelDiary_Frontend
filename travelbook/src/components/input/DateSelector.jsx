...
const DateSelector = ({ date, setDate }) => {  // Fixed props destructuring
    ...
    return (
        <div>
            ...
            {openDatePicker && (  // Only show the date picker when openDatePicker is true
                <div className='overflow-y-scroll p-5 bg-sky-50/80 rounded-lg relative pt-9'>
                    ...
                    >
                        <MdClose className='text-sky-600'/>
                    </button> 
